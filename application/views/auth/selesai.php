...
<body>
    ...
    <div class="container">
        ...
        <div class="card mt-5">
            <div class="card-body">
                <h3>TERIMA KASIH ATAS PENILAIAN EVALUASI PENERAPAN SISTEM SIMRS JIWA BANDA ACEH YANGTELAH ANDA LAKUKAN. PENILAIAN INI AKAN MENJADI BAHAN PERTIMBANGAN BAGI KAMI UNTUK KEMAJUAN YANG AKAN DATANG</h3>
            </div>
        </div>
    </div>
    <!-- Bordered table end -->
